...
/**
  ...
  */
object MLlib_GradientBoostedTreeClassifier {
  def main(args: Array[String]): Unit = {
    /**
      * 初始化
      */
    //val conf = new SparkConf().setAppName("MLlib_GradientBoostedTreeClassifier").setMaster("spark://10.2.8.11:7077")
    val conf = new SparkConf().setMaster("local[4]").setAppName("MLlib_GradientBoostedTreeClassifier")
